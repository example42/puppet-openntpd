...
describe 'openntpd' do
  ...
  describe 'Test standard installation' do
    ...
    it { should contain_service('openntpd').with_enable('true') }
    it { should contain_file('openntpd.conf').with_ensure('present') }
  end
  ...
  describe 'Test standard installation with monitoring and firewalling' do
    ...
    it 'should monitor the process' do
      content = catalogue.resource('monitor::process', 'openntpd_process').send(:parameters)[:enable]
      content.should == true
    end
  ...
  describe 'Test decommissioning - absent' do
    ...
    it 'should not enable at boot Service[openntpd]' do should contain_service('openntpd').with_enable('false') end
    it 'should remove openntpd configuration file' do should contain_file('openntpd.conf').with_ensure('absent') end
  ...
  describe 'Test decommissioning - disableboot' do
    ...
    it { should_not contain_service('openntpd').with_ensure('absent') }
    it 'should not enable at boot Service[openntpd]' do should contain_service('openntpd').with_enable('false') end
    it { should contain_file('openntpd.conf').with_ensure('present') }
  ...
  describe 'Test customizations - template' do
    let(:params) { {:template => "openntpd/spec.erb" , :options => { 'opt_a' => 'value_a' } } }

    it 'should generate a valid template' do
      content = catalogue.resource('file', 'openntpd.conf').send(:parameters)[:content]
  ...
  describe 'Test customizations - source' do
    let(:params) { {:source => "puppet://modules/openntpd/spec" , :source_dir => "puppet://modules/openntpd/dir/spec" , :source_dir_purge => true } }

    it 'should request a valid source ' do
      content = catalogue.resource('file', 'openntpd.conf').send(:parameters)[:source]
      content.should == "puppet://modules/openntpd/spec"
    end
    it 'should request a valid source dir' do
      content = catalogue.resource('file', 'openntpd.dir').send(:parameters)[:source]
      content.should == "puppet://modules/openntpd/dir/spec"
    end
    it 'should purge source dir if source_dir_purge is true' do
      content = catalogue.resource('file', 'openntpd.dir').send(:parameters)[:purge]
      content.should == true
    end
  end

  describe 'Test customizations - custom class' do
    let(:params) { {:my_class => "openntpd::spec" } }
  ...
  describe 'Test Puppi Integration' do
    ...
    it 'should generate a puppi::ze define' do
      content = catalogue.resource('puppi::ze', 'openntpd').send(:parameters)[:helper]
  ...
  describe 'Test OldGen Module Set Integration' do
    ...
    it 'should generate puppi resources ' do 
      content = catalogue.resource('puppi::ze', 'openntpd').send(:parameters)[:ensure]
  ...
  describe 'Test params lookup' do
    let(:facts) { { :openntpd_monitor => true , :ipaddress => '10.42.42.42' } }
    let(:params) { { :port => '42' } }
  ...
  describe 'Test params lookup' do
    let(:facts) { { :monitor => false , :openntpd_monitor => true , :ipaddress => '10.42.42.42' } }
    let(:params) { { :port => '42' } }
